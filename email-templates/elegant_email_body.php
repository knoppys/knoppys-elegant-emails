...
function elegant_email_body($messagtext,$properties){ 
	...
	<div>
		<div class="block-grid" style="Margin: 0 auto;min-width: 320px;max-width: 600px;width: 600px;width: calc(29000% - 179200px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #FFFFFF;">
		    ...
		    <table cellspacing="0" cellpadding="10" class="" width="" style="" border-collapse="collapse">
		        <tbody>
		            <tr>    
		                <td>
	                	    ...
	                	    <table cellspacing="0" cellpadding="0" class="" width="500" style="width:100%;background: #fff;" border-collapse="collapse">
	                	        <tbody>
	                	            <tr>     	                
		            		...
		            		<div style="margin-top:10px;border-bottom:1px solid #d2d2d2;padding-bottom: 10px">
		            			<p style="margin: 0;font-size: 14px;line-height: 18px;text-align: left"><span style="font-size: 14px; line-height: 1.5; font-weight: normal;"><?php echo $property[1]; ?></span></p>
		            		</div>	
		            	</td>
		            </tr>
		        </tbody>
